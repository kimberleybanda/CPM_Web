<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="ProductSettings.aspx.cs" Inherits="CPMv2.ProductSettings" Title="GridView" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
                     ...
                     <div class="row">
                         ...
                         <div class="col-md-6 mb-md-0 mb-4">
                             ...
                             <div class="input-group input-group-outline my-2">
                                 <asp:TextBox Enabled="True" id="txtName"  class="form-control" runat="server"/>
                             </div>

                         </div> 
                         </div>

                     <asp:Button ID="btnCreateProduct" OnClick="CreateProduct_Click"  class="btn bg-gradient-dark w-100 my-4 mb-2" Text="Create" runat="server"/>
                 </div>
             </div>
           </div>
          ...
          <div class="card-body p-3">
              <div class="card-header pb-0 p-3">
                  <div class="row">
                      <div class="col-6 d-flex align-items-center">
                          <h6 class="mb-0">Product View & Edit </h6>
                      </div>
                  </div>
              </div>
              <div class="col-lg-6 col-7">

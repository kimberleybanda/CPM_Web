<%@ Page Language="C#" Async="true" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="TrainingSettings.aspx.cs" Inherits="CPMv2.TrainingSettings" Title="GridView" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <div class="col-lg-6 col-md-6">
        <div class="card-body p-3">
            <div class="card-header pb-0 p-3">
                <div class="row">
                    <div class="col-6 d-flex align-items-center">
                        <h6 class="mb-0">Video Training Settings</h6>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 mb-md-0 mb-4">
                    ...
                    <div class="input-group input-group-outline my-2">
                        <asp:TextBox Enabled="True" ID="txtTutorialName" class="form-control" runat="server" />
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <asp:Button ID="btnCreateTutorialVid" OnClick="CreateTutorialVid_Click" class="btn bg-gradient-dark w-50 my-4 mb-2" Text="Create" runat="server" />
        </div>
    </div>
    ...
    <div class="col-lg-6 col-md-6">
        <div class="card-body p-3">
            <div class="card-header pb-0 p-3">
                <div class="row">
                    <div class="col-6 d-flex align-items-center">
                        <h6 class="mb-0">Pdf Training Settings</h6>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 mb-md-0 mb-4">
                    <label class="form-label">Tutorial Name</label>
                    <div class="input-group input-group-outline my-2">
                        <asp:TextBox Enabled="True" ID="txtPdfName" class="form-control" runat="server" />
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <asp:Button ID="btnCreateTutorialPdf" OnClick="CreateTutorialPdf_Click" class="btn bg-gradient-dark w-50 my-4 mb-2" Text="Create" runat="server" />
        </div>
    </div>
</div>
                   </div>
        ...
        <div class="card-body p-3">
            ...
            <dx:ASPxGridView  KeyFieldName="id" OnContextMenuItemClick="Grid_ContextMenuItemClick"  OnContextMenuInitialize="Grid_ContextMenuInitialize" ID="GridView1" runat="server" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="tutorialName"/>
    ...
    <div class="col-lg-6 col-md-6">
        <div class="card-body p-3">
            ...
            <dx:ASPxGridView  KeyFieldName="id" OnContextMenuItemClick="Grid_ContextMenuItemClick2"  OnContextMenuInitialize="Grid_ContextMenuInitialize2" ID="GridView2" runat="server" Width="100%">
                <Columns>
                    <dx:GridViewDataTextColumn FieldName="id"/>
                    <dx:GridViewDataTextColumn FieldName="tutorialName"/>
